...
public class GoodsMaxController {
    ...
    public JsonResult<JsonPage<GoodsMax>> pageGood(@RequestParam Integer pageNum, @RequestParam Integer pageSize) {
        // 分页查询调用
        JsonPage<GoodsMax> allGoodsMaxByPage = service.getAllGoodsByPage(pageNum, pageSize);
