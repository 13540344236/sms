...
public class SupplierController {
    ...
    public JsonResult<JsonPage<Supplier>> pageSupplier(@RequestParam Integer pageNum, @RequestParam Integer pageSize) {
        // 分页查询调用
        JsonPage<Supplier> allSupplierByPage = service.getAllSupplierByPage(pageNum, pageSize);
