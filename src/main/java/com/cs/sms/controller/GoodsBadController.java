...
public class GoodsBadController {
    ...
    public JsonResult<JsonPage<GoodsBad>> pageGood(@RequestParam Integer pageNum, @RequestParam Integer pageSize) {
        // 分页查询调用
        JsonPage<GoodsBad> allGoodsBadByPage = service.getAllGoodsBadByPage(pageNum, pageSize);
        return JsonResult.ok("查询成功!",allGoodsBadByPage);
    }
